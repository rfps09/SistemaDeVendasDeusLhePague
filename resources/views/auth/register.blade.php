    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="cpf" class="block mt-1 w-full" type="text" name="cpf" required />
            </div>

            <div class="mt-4">
                <x-jet-label for="classe" value="{{ __('Renda') }}" />
                <select name="classe" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
