    ...
    <div class="container">
        <main class="row justify-content-md-center">
            ...
            <div class="col col-lg-5">
                <form class="needs-validation" action="{{ route('salvarProduto') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="valorUnitario" name="valorUnitario" placeholder="9999.99" required>
                        <div class="invalid-feedback">
                            Insira um valor.
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="unidade" name="unidade" placeholder="1" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="estoqueMinimo" name="estoqueMinimo" placeholder="1" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="qtdEstoque" name="qtdEstoque" placeholder="1" required>
                        <div class="invalid-feedback">
